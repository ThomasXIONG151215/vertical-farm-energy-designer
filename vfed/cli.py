...
_YAML_SECTION_COMMENTS = {
    ...
    "envelope": (
        ...
        "#   U_wall_A    - envelope conductance UA (W/K); estimate as sum(U_i*A_i):\n"
        "#                 PU/PIR panel 0.2-0.45, insulated brick 0.5-1.0, plain\n"
        "#                 brick/concrete 1.5-2.5, single glazing ~5-6 (W/m2K)\n"
        "#   ach         - infiltration air changes per hour (sealed room 0.01-0.02)\n"
    ...
    "hvac": (
        ...
        "#   P_rated_w   - rated electrical power (W); capacity = P_rated_w x COP\n"
        "#   auto_size   - true = size capacity from the design-day load\n"
        "#                 (design_T_ext, shr_design 0.6-0.8, safety_factor ~1.2)\n"
