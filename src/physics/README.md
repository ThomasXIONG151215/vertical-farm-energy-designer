...
**Leaf module** — no internal `src/` imports. Uses only `math`, `dataclasses`, `typing`.

## Usage

```python
from src.physics.psychrometrics import temp_rh_to_ah, saturation_vapor_pressure
from src.physics.envelope import Envelope
